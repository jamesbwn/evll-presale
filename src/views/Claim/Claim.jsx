        ...
        {totalPurchasedAmount && 
          <Grid item>
            <div className="stake-top-metrics data-row-centered" style={{marginBottom: "18px"}}>
              ...
              <Typography className="presale-items" style={{marginLeft: "16px"}}><span style={{color: "#11d59e"}}>{totalPurchasedAmount / 5} EVLL</span></Typography>
            </div>
          </Grid>
        } */}
          ...
          <Grid item>
            <div className="stake-top-metrics data-row-centered" style={{marginBottom: "18px"}}>
              <Typography className="presale-items">Your EVLL Balance:</Typography>
              <Typography className="presale-items" style={{marginLeft: "16px"}}><span style={{color: "#11d59e"}}>{bptBalance ? Number.parseFloat(bptBalance).toFixed(3) : 0} EVLL</span></Typography>
            </div>
          </Grid>
        ...
        {claimableAmount && 
          <Grid item>
            <div className="stake-top-metrics data-row-centered" style={{marginBottom: "18px"}}>
              ...
              <Typography className="presale-items" style={{marginLeft: "16px"}}><span style={{color: "#11d59e"}}>{claimableAmount} EVLL</span></Typography>
            </div>
          </Grid>
        }
        <Grid item>
